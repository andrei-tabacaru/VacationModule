...
namespace VacationModule.Core.ServiceContracts
{
    ...
    public interface INationalHolidaysService
    {
        ...
        Task<NationalHolidayResponse> AddNationalHolidayAsync(NationalHolidayAddRequest? nationalHolidayAddRequest);

        /// <summary>
        /// Returns all national holidays
        /// </summary>
        /// <returns>All national holidays from the list as List of NationalHolidayResponse</returns>
        Task<List<NationalHolidayResponse>> GetAllNationalHolidaysAsync();
        ...
        Task<NationalHolidayResponse?> GetNationalHolidayByIdAsync(Guid? Id);
        ...
        Task<NationalHolidayResponse> UpdateNationalHolidayAsync(NationalHolidayUpdateRequest? nationalHolidayUpdateRequest);
        ...
        Task<bool> DeleteNationalHolidayAsync(Guid? Id);
        ...
        Task<List<NationalHolidayResponse>> UpdateYearToAsync(int year);
    }
}
