...
REST API vacation module that lets users fill in the dates for
their vacation days. It takes into consideration the working days of the week as
well as the national holidays. Each user should starts from 25 available vacation days per
year.
